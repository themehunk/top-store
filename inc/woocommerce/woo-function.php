...
<a class="account" href="<?php echo esc_url(get_permalink( get_option('woocommerce_myaccount_page_id') ));?>"><span class="account-text tooltip"><?php _e('Account','top-store');?></span><span class="account-text"><?php top_store_display_admin_name(); ?></span><i class="th-icon th-icon-user"></i></a>
<?php } else {?>
<span><a href="<?php echo esc_url(get_permalink( get_option('woocommerce_myaccount_page_id') ));?>"><span class="account-text tooltip"><?php _e('Account','top-store');?></span><span class="account-text"><?php _e('Account','top-store');?></span><i class="th-icon th-icon-lock1"></i></a></span>
<?php }
 }
